...
<body>
	...
	<div class = "container-fluid my-5">
		...
		<c:if test="${not empty user}">
			...
			<div>
				<textarea name="boardContents" class="form-control is-invalid" id="productComment" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
