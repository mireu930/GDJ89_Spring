...
<body>
	...
	<div class = "container-fluid my-5">
		<div class = "row col-md-8 offset-md-2">
			<form class="row g-3" action = "./mypage" method = "post">
			  <div class="col-md-4">
			    <label for="user_name" class="form-label">아이디</label>
			    <div class="input-group has-validation">
			      <input type="text" name="user_name" value="${dto.user_name}"  class="form-control is-invalid" id="validationServer02" aria-describedby="inputGroupPrepend3 validationServerServer02Feedback" required>
			  ...
			  <div class="col-md-4">
			    ...
			    <div class="input-group has-validation">
			      <input type="password" name="password" value="${dto.password}" class="form-control is-invalid" id="validationServerUsername" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
			  ...
			  <div class="col-md-6">
			    ...
			    <input type="text" name = "name" value="${dto.name}" class="form-control is-invalid" id="validationServer03" aria-describedby="validationServer03Feedback" required>
			  ...
			  <div class="col-md-3">
			    ...
			    <input type="text" name ="phone" value="${dto.phone}" class="form-control is-invalid" id="validationServer04" aria-describedby="validationServer04Feedback" required>
			  ...
			  <div class="col-md-3">
			    ...
			    <input type="text" name ="email" value="${dto.email}" class="form-control is-invalid" id="validationServer05" aria-describedby="validationServer05Feedback" required>
