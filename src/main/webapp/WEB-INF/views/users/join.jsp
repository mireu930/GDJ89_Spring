...
<title>Insert title here</title>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			var productPeriodInput = document.getElementById('validationServer05');
			productPeriodInput.addEventListener('input', function () {
		...
		<div class = "row col-md-8 offset-md-2">
			<form class="row g-3" action = "./join" method = "post">
			  ...
			  <div class="col-md-3">
			    ...
			    <input type="text" name ="phone" class="form-control is-invalid" id="validationServer04" aria-describedby="validationServer03Feedback" required>
