			...
			<form class="row g-3" action = "./update" method = "post">
			  <div class="col-md-4">
			    <div class="input-group has-validation">
			      <input type="hidden" name="accountNum" value="${account.accountNum}"  class="form-control is-invalid" id="validationServer01" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
			    </div>
			    
			    <div class="input-group has-validation">
			      <label for="productNum" class="form-label">상품번호</label>
			      <input type="text" name="productNum" value="${account.productNum}"  class="form-control is-invalid" id="validationServer02" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
			  ...
			  <div class="col-md-4">
			    <label for="accountsBalance" class="form-label">잔액</label>
			    <div class="input-group has-validation">
			      <input type="text" name="accountsBalance" value="${account.accountsBalance }" class="form-control is-invalid" id="validationServerUsername" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
